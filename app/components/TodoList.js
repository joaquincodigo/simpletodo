...
export default function TodoList({ todos, removeTodo, toggleTodo, showCompleted }) {
  return (
    <div className="todo-list shadow-lg overflow-y-scroll scrollbar-thin scrollbar-track-transparent scrollbar-thumb-slate-500 h-80 w-72 mx-auto mb-2 bg-white bg-opacity-20 rounded-lg scrollbar-thumb-rounded-full p-3">
      {todos.length === 0 ? (
